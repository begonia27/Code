...
5. >$n$ 个变元的布尔函数 $F$ 和 $G$ s是相等的，当且仅当 $F(b_1,b_2, \cdot \cdot \cdot , b_n) = G(b_1,b_2, \cdot \cdot \cdot , b_n)$ ，其中 $b_1,b_2, \cdot \cdot \cdot , b_n$ 属于 $B$ 。表达 **同一个函数的布尔表达式** 称为是 **等价** 的。
