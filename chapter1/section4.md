...
* $a.\forall (z(x) \wedge p(x))(其中z(x)为班上的学生，p(x)为x会说印地语)$
...
* $a.\forall (z(x) \rightarrow p(x))(其中z(x)为班上的学生，p(x)为x有移动电话)$
* $b.\forall (z(x) \wedge p(x))(其中z(x)为班上的学生，p(x)为x曾看过外国影片)$
* $c.\forall (z(x) \wedge \neg p(x))(其中z(x)为班上的学生，p(x)为x会游泳)$
* $d.\forall (z(x) \wedge p(x))(其中z(x)为班上的学生，p(x)为x会求解二次方程)$
* $e.\forall (z(x) \rightarrow \neg p(x))(其中z(x)为班上的学生，p(x)为x想变富)$
